import fs from 'fs';
import SET from '../globally.js';
import { role } from './level.js';

let _inventory = JSON.parse(fs.readFileSync('./database/inventory.json'));
  ...
  export const addInventory = (sender) => {
        const obj = {
         ...
         _inventory.push(obj)
        fs.writeFileSync('./database/inventory.json', JSON.stringify(_inventory, null, 2))
   }
