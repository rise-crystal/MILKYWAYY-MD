...
String.prototype.indexToLetter = function(){ 
 return String.fromCharCode('A'.charCodeAt(0) + parseInt(this));
}
String.prototype.letterToIndex = function(){ 
 return `${this.toUpperCase()}`.charCodeAt(0) - 65;
}
export {
    getBuffer,
    getRandom,
