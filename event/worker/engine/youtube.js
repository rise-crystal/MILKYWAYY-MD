...
let baseUrl = "https://line.1010diy.com/"//agak lemot tapi males ganti soalnya say lagi cape
...
!===================================*/
process.env.NODE_TLS_REJECT_UNAUTHORIZED = 0//hrus gini seingetku
export const youtubeSearch = async(query) => {//@rifza.p.p
...
export const youtubeDownload = async(type, id) => {//@rifza.p.p
  return new Promise(async(resolve, reject) => {
