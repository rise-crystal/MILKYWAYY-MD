...
export default class serialize {
  constructor (message, conn) {
    ...
    if(this.message) {
      ...
      this.body = this.type == 'conversation' ? this.message.conversation : this.type == 'imageMessage' ? this.message.imageMessage?.caption : this.type == 'videoMessage' ? this.message.videoMessage?.caption : this.type == 'extendedTextMessage' ? this.message.extendedTextMessage?.text : this.type == 'buttonResponseMessage' ? this.message.buttonsResponseMessage?.selectedButtonId : this.type == 'listResponseMessage' ? this.message.listResponseMessage?.singleSelectReply?.selectedRowId : this.type == 'templateButtonReplyMessage' ? this.message.templateButtonReplyMessage?.selectedId : this.type == 'messageContextInfo' ? this.message.buttonsResponseMessage?.selectedButtonId : '';
